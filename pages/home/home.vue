		...
		<scroll-view>
			...
			<swiper class="screen-swiper square-dot"  :indicator-dots="true" :circular="true"
			 :autoplay="true" interval="5000" duration="500" :style="[{animation: 'show 0.2s 1'}]">
				<swiper-item v-for="(item,index) in swiperList" :key="index" @click="gotozfb(item.link)">
...
<script>
	...
	export default {
		...
		data() {
			return {
			 swiperList: [
				  {id:1,type: 'image',url: '/static/banner/banner1.png', link: 'https://qr.alipay.com/fkx13578bxlmmuehmvnqy77'},
				  {id:2,type: 'image',url: '/static/banner/banner2.jpg', link: 'https://qr.alipay.com/fkx13578bxlmmuehmvnqy77'},
				  {id:3,type: 'image',url: '/static/banner/banner3.jpg', link: 'https://qr.alipay.com/fkx13578bxlmmuehmvnqy77'},
				  {id:4,type: 'image',url: '/static/banner/banner4.jpg', link: 'https://qr.alipay.com/fkx13578bxlmmuehmvnqy77'},
				],
				middleApps: [
